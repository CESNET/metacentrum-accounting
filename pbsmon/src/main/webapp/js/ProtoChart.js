...
Proto.Chart = Class.create({
    ...
    this.canvas = (!hasCanvas ? document.createElement("canvas") : new Element("CANVAS", {'width': this.canvasWidth, 'height': this.canvasHeight}));
...
*/
		...
		this.overlay = (!hasCanvas) ? document.createElement("canvas") :  new Element("CANVAS", {'width': this.canvasWidth, 'height': this.canvasHeight});

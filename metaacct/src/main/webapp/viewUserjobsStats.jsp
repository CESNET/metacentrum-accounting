...
<fmt:message var="titlestring" scope="request" key="stats.userjobs.title" />
...
<table>
  <tr>
    <td>
      <s:form name="day" action="/UsernameJobs.action">
    ...
    <td>
      <s:form name="week" action="/UsernameJobs.action">
    ...
    <td>
      <s:form name="month" action="/UsernameJobs.action">
    ...
    <td>
      <s:form name="3months" action="/UsernameJobs.action">
    ...
    <td>
      <s:form name="6months" action="/UsernameJobs.action">
    ...
    <td>
      <s:form name="year" action="/UsernameJobs.action">
  ...
  <tr>
    <td colspan="6">
      <stripes:form action="/UsernameJobs.action">
        <stripes:errors/>
...
<div id="main" align="center">
	<display:table cellpadding="0" cellspacing="0" class="data" requestURI="" name="${actionBean.userStats}" sort="external" id="element">	  
	  ...
	  <display:column property="jobsSum" sortable="true" sortName="jobsSum" titleKey="stats.userjobs.jobsSum" headerClass="data" class="data" />

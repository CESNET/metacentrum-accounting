...
<fmt:message var="titlestring" scope="request" key="pbsRecords.title" ><fmt:param value="test"/></fmt:message>
...
<s:layout-render name="/layout.jsp" >
  ...
  <div id="page">
    ...
    <table> 
      <tr>
        <td colspan="3">
          <stripes:form action="/AllPbs.action">
      ...
      <s:form name="filter" action="/AllPbs.action">
          <input type="hidden" name="pageSize" value="${actionBean.pbsRecords.objectsPerPage}">
          <div class="filtr">
            ...
            <div class="form">
              <table>
                <tr>
                  ...
                  <td><s:text name="filter.idString"></s:text></td>
                  <td class="polozka"><fmt:message key="pbs.name" />:</td>
                  <td><s:text name="filter.jobname"></s:text></td>
                </tr>
                <tr>
				  <td class="polozka"><fmt:message key="pbs.username" />:</td>
                  <td><s:text name="filter.username"></s:text></td>
                  <td class="polozka"><fmt:message key="pbs.queue" />:</td>
                  <td><s:text name="filter.queue"></s:text></td>                  
                </tr>
				<tr>                  
                  <td class="polozka"><fmt:message key="pbs.serverHostname" />:</td>
                  <td><s:text name="filter.pbsServer"></s:text></td>
				  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
				<tr>
                ...
                <tr>
                  ...
                  <td>
                    <s:text id="filter.dateTimeFrom" name="filter.dateTimeFrom" formatType="date" formatPattern="${dateformat}"></s:text>
                  ...
                  <td class="polozka"><fmt:message key="filter.to" />:</td>
                  <td>
                    <s:text id="filter.dateTimeTo" name="filter.dateTimeTo" formatType="date" formatPattern="${dateformat}"></s:text>
                ...
                <tr>
                  ...
                  <td>
                    <s:text id="filter.createTimeFrom" name="filter.createTimeFrom" formatType="date" formatPattern="${dateformat}"></s:text>
    ...
    <div id="main" align="center">
    	...
    	<display:table cellpadding="0" cellspacing="0" class="data" requestURI="" name="${actionBean.pbsRecords}" sort="external" id="element">
		  ...
		  <display:column property="username" sortable="true" sortName="username" titleKey="pbs.username" headerClass="data" class="data" />

...
public class Column
{
    ...
    /**
     * <strong>Modified for needs of metaaccounting</strong>
     * 
    ...
    public Object getValue(boolean decorated) throws ObjectLookupException, DecoratorException
    {
        ...
        {
            //this if moved from start of method - static value have to be set after decoration if object is still null
            if (this.cell.getStaticValue() != null) {
                object = this.cell.getStaticValue();
            } else if (!this.header.getShowNulls())
            {

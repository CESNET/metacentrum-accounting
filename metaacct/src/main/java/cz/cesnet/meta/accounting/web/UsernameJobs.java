...
public class UsernameJobs extends AccountingWebBase {
  ...
  public Resolution view() {    
    ...
    userStats = pbsRecordManager.getUserjobStats(fromDate, toDate, getPageNumber(), PaginationFilter.DEFAULT_PAGE_SIZE_LONG, getPageSize(), getSortColumn(), isAscending());
    return new ForwardResolution("/viewUserjobsStats.jsp");
  } 
